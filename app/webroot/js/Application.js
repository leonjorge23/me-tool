...
$(function (){
   ...
   if ($url === '/staging/couples/'){
       $('#couples-tab').addClass('active');
   } else if ($url.indexOf('/couplesweekends/') >= 0){
       $('#records-tab').addClass('active');
   } else if ($url === "/staging/"){
       $('#home-tab').addClass('active'); 
   } else if ($url === "/staging/couples/add"){
       $('#add-couple-tab').addClass('active');
   } else if ($url === "/staging/couplesWeekends/"){
       $('#records-tab').addClass('active');
   }
});